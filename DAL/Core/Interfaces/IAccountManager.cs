...
namespace DAL.Core.Interfaces
{
    public interface IAccountManager
    {
        ...
        Task<(ApplicationUser User, string[] Roles, List<Claim> Claims)?> GetUserAndRolesAsync(string userId);
        ...
        Task<(bool Succeeded, string[] Errors)> UpdateUserAsync(ApplicationUser user, IEnumerable<string> roles, IEnumerable<Claim> claims);
